...
ALTER TABLE tax.trades ADD COLUMN IF NOT EXISTS canonical_asset VARCHAR(50);
ALTER TABLE tax.deposits ADD COLUMN IF NOT EXISTS canonical_asset VARCHAR(50);
ALTER TABLE tax.withdrawals ADD COLUMN IF NOT EXISTS canonical_asset VARCHAR(50);
